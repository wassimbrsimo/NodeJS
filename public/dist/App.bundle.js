...
exports.prev = exports.next = exports.storesAjax = undefined;
...
function getStores(Stores, Pagination) {
  ...
  _axios2.default.get('/api/stores/' + Page).then(function (res) {
    if (res.data) {
      Page = res.data.page;
...
var _storesAjax = __webpack_require__(13);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _storesAjax.storesAjax)((0, _bling.$)('.stores'), (0, _bling.$)('p'));
...
var nex = (0, _bling.$$)('form.next');
nex.on('submit', function (e) {
  e.preventDefault();(0, _storesAjax.next)((0, _bling.$)('.stores'), (0, _bling.$)('p'));
});

var back = (0, _bling.$$)('form.prev');
back.on('submit', function (e) {
  e.preventDefault();(0, _storesAjax.prev)((0, _bling.$)('.stores'), (0, _bling.$)('p'));
});
